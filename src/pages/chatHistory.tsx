  ...
  return (
    <div className="flex flex-col py-8 pr-8 h-screen">
      <div className="h-full flex rounded-[20px] bg-white border border-blue-gray-100 dark:bg-maroon-400 dark:border-maroon-600 w-full">
        <div className="w-1/6 bg-yellow-gray-50 rounded-l-[20px] border-r border-l-blue-gray-100 flex flex-col justify-start">
        ...
        <div className='p-5'>
          {conversationLoader === 'pending'?<p>Loading...</p>:messages?.map((message, index) => {
            if (message?.question) {
              return (
